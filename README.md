...
Execution Time: 256.171620 seconds
Verification: C[0][0] = 4000.00
The result was successfully verified.
Screenshot
...
The result was successfully verified.
Speedup
The sequential execution time was 256.171620 seconds.
...
Therefore, the OpenMP implementation achieved approximately 6.34× speedup compared with the sequential implementation.
Screenshot
...
The OpenMP implementation reduced the execution time from 256.171620 seconds to 40.364523 seconds.
Conclusion
Both the Sequential and OpenMP implementations successfully performed matrix multiplication on 4000 × 4000 matrices and produced the expected verification value:
C[0][0] = 4000.00
